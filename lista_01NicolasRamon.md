...
class Funcionario {
    constructor(nome, idade, salarioBase) {
        ...
        this.salarioBase = salarioBase; //salariobase
        this.salarioTotal = 0; //total do salario antes de fazer o calculo
    }

    calcularSalario() {
        this.salarioTotal = this.salarioBase; //Aqui o salario ainda não possui valor
    }
}

class Professor extends Funcionario {
    constructor(nome, idade, salarioBase, disciplina, horasAulaPorSemana) {
        super(nome, idade, salarioBase); //chama propriedades Funcionario
        this.disciplina = disciplina; //disciplina do professor
        this.horasAulaPorSemana = horasAulaPorSemana;
    }

    calcularSalario() {
        const valorHoraAula = 53.5; //Valor da hora trabalhada
        this.salarioTotal = this.horasAulaPorSemana * valorHoraAula;//multiplica o valor da hora pelo tempo que é trabalhado
    }
}
